				...
				<div class="form-group" id="student_number_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_number"
							name="staff_number" placeholder="请输入员工工号（全为数字且长度为11）"
							value="${staff.number}" onchange="checkStaff_number()"
							oninput="">
					</div>
				</div>
				...
				<div class="form-group" id="student_name_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_name"
							name="staff_name" placeholder="请输入员工姓名" value="${staff.name}"
				...
				<div class="form-group" id="student_age_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_age"
							name="staff_age" placeholder="请输入员工年龄" value="${staff.age}"
				...
				<div class="form-group" id="student_age_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_performance"
							name="staff_performance" placeholder="请输员工业绩"
				...
				<div class="form-group" id="student_age_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_bonus"
							name="staff_bonus" placeholder="请输员工奖金" value="${staff.bonus}"
				...
				<div class="form-group" id="student_age_class">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="staff_house"
							name="staff_house" placeholder="请输员工家庭住址"
							value="${staff.house}" onchange="checkStaff_house()"
							oninput="">
					</div>
				</div>
...
$('#staff_position').val('${staff.position}');
</script>
