...
<div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">员工信息修改</h3>
        </div>
        <div class="panel-body">
            <form name="studentForm" class="form-horizontal" role="form" method="post" 
            action="/STSM/StaffUpdate" onsubmit="return checkAll()" >
                ...
                <div class="form-group" id="student_number_class">
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输入员工工号（全为数字且长度为11）" value="${staff.number}" onchange="checkStaff_number()"
                ...
                <div class="form-group" id="student_name_class">
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输入员工姓名" value="${staff.name}" onchange="checkStaff_name()"
                ...
                <div class="form-group" id="student_age_class">
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输入员工年龄" value="${staff.age}" onchange="checkStaff_age()"
...
<%--                         placeholder="请输员工职位" value="${staff.position }" onchange="checkStaff_position()" --%>
<!--                         oninput="Inputing(document.getElementById('staff_position_span'),document.getElementById('staff_position_class'))"> -->
                    </div>
                </div>
                 ...
                 <div class="form-group" id="student_age_class">
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输员工业绩" value="${staff.performance }" onchange="checkStaff_performance()"
                 ...
                 <div class="form-group" id="student_age_class">
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输员工奖金" value="${staff.bonus}" onchange="checkStaff_bonus()"
                    ...
                    <div class="col-sm-8">
                        ...
                        placeholder="请输员工家庭住址" value="${staff.house}" onchange="checkStaff_house()"
                        oninput="Inputing(document.getElementById('staff_house_span'),document.getElementById('staff_house_class'))">
                    </div>
                </div>
                
<!--                 <div class="form-group" id="student_age_class"> -->
<!--                     <label for="student_age" class="col-sm-2 control-label"><a class="text-danger"></a>考勤时间(上班)</label> -->
<!--                     <div class="col-sm-8"> -->
<!--                         <input type="text" class="form-control" id="staff_last_in" name="staff_last_in"  -->
<%--                         placeholder="请输员工考勤时间(上班)" value="${staff.lastIn}" onchange="checkStaff_last_in()" --%>
<!--                         oninput="Inputing(document.getElementById('staff_last_in_span'),document.getElementById('staff_last_in_class'))"> -->
<!--                     </div> -->
<!--                 </div> -->
                
<!--                 <div class="form-group" id="student_age_class"> -->
<!--                     <label for="student_age" class="col-sm-2 control-label"><a class="text-danger"></a>考勤时间(下班)</label> -->
<!--                     <div class="col-sm-8"> -->
<!--                         <input type="text" class="form-control" id="staff_last_out" name="staff_last_out"  -->
<%--                         placeholder="请输员工考勤时间(下班)" value="${staff.lastOut}" onchange="checkStaff_last_out()" --%>
<!--                         oninput="Inputing(document.getElementById('staff_last_out_span'),document.getElementById('staff_last_out_class'))"> -->
<!--                     </div> -->
<!--                 </div> -->
					<!--          员工id -->
                <input type="hidden" value="${staff.ID}" name="staff_id" id="staff_id">
					<!--          员工id -->
...
$("#staff_sex[type='radio']").each(function() {
    if($(this).val()=='${staff.sex}'){
    	$(this).prop('checked',true);
   	}
});
$("#staff_position[type='radio']").each(function(){
	  if($(this).val()=='${staff.position}'){
    	$(this).prop('checked',true);
   	}
});
</script>
