			...
			<ul class="nav">
				...
				<li>
					...
					<div id="company_audit" class="collapse">
						<ul class="nav">
							<li><a href="/STSM/admin/audit/company/wait_audit_company" id="wait_audit_company" class="">待审核企业</a></li>
							<li><a href="/STSM/admin/audit/company/approved_company" id="approved_company" class="">审核通过企业</a></li>
							<li><a href="/STSM/admin/audit/company/unapproved_company" id="unapproved_company" class="">审核未通过企业</a></li>
						</ul>
					</div>
				</li>
				...
				<li>
					...
					<div id="job_audit" class="collapse">
						<ul class="nav">
							<li><a href="/STSM/admin/audit/job/wait_audit_job" id="wait_audit_job" class="">待审核职位</a></li>
							<li><a href="/STSM/admin/audit/job/approved_job" id="approved_job" class="">审核通过职位</a></li>
							<li><a href="/STSM/admin/audit/job/unapproved_job" id="unapproved_job" class="">审核未通过职位</a></li>
						</ul>
					</div>
				</li>
