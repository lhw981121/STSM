...
/**
 * Servlet implementation class MessageMarkAllRead
 */
@WebServlet("/MessageMarkAllRead")
public class MessageMarkAllRead extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MessageMarkAllRead() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isOK = mes.updateMessageAllReaded(receiver_id);
