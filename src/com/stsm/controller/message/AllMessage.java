...
/**
 * Servlet implementation class AllMessage
 */
@WebServlet(urlPatterns = {"/message/all_message"})
public class AllMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int deleted = 0;
		//排序字段
		String sortField = "message_readed,created_at DESC";
		//获取单页记录数
		...
		request.getRequestDispatcher("/WEB-INF/view/message/allMessage.jsp").forward(request, response);
	}
